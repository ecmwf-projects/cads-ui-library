...
import { NestedStringListArrayWidget } from '../../src'

import { getNestedStringListArrayWidgetConfiguration } from '../../__tests__/factories'
...
describe('<StringListArrayWidget/>', () => {
  ...
  it('hydrates its selection', () => {
    ...
    cy.mount(
      <NestedStringListArrayWidget
        configuration={getNestedStringListArrayWidgetConfiguration()}
      />
    )
  ...
  it('appends current selection for closed accordions - select all/clear all', () => {
    ...
    cy.mount(
      ...
      >
        <NestedStringListArrayWidget
          configuration={{
            ...getNestedStringListArrayWidgetConfiguration(),
            details: {
              ...getNestedStringListArrayWidgetConfiguration().details,
              accordionOptions: {
                openGroups: [],
                searchable: false
              }
